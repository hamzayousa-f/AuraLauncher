        ...
        private var channelInstance: MethodChannel? = null
            ...
            private var lastBlockedPackageName: String? = null
                ...
                override fun configureFlutterEngine(@NonNull flutterEngine: FlutterEngine) {
                    ...
                    // Cache the master messenger instance for reactive execution frames
                    ...
                    // Handle case where app starts up from scratch directly due to an intercept event
                ...
                override fun onNewIntent(intent: Intent) {
                    ...
                    setIntent(intent) // Ensure internal intent state is correctly updated
