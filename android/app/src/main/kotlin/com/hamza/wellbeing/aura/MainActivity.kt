...
class MainActivity: FlutterActivity() {
    ...
    private val SYNC_CHANNEL = "com.aura.blocker/sync"
    private var packageRemovedReceiver: BroadcastReceiver? = null
        ...
        private var lastBlockedPackageName: String? = null
            ...
            override fun configureFlutterEngine(@NonNull flutterEngine: FlutterEngine) {
                ...
                // 1. Launcher Channel Configuration
                MethodChannel(flutterEngine.dartExecutor.binaryMessenger, CHANNEL).setMethodCallHandler { call, result ->
                    when (call.method) {
                        ...
                        "getBlockedPackage" -> {
                            // Flutter calls this on hot-resuming to check if it needs to paint the block overlay
                            val pkg = lastBlockedPackageName
                            lastBlockedPackageName = null // Flush cache after reading
                            result.success(pkg)
                        }
            ...
            override fun onNewIntent(intent: Intent) {
                ...
                // Catch package routing payloads sent from AuraBlockerService
                ...
                if (!blockedPackage.isNullOrEmpty()) {
                    ...
                    // Proactively ping Flutter via our MethodChannel loop to lock the view instantly
                    flutterEngine?.dartExecutor?.binaryMessenger?.let { messenger ->
                        MethodChannel(messenger, CHANNEL).invokeMethod("nativeAppBlockedIntercepted", blockedPackage)
                    }
                }
            }
