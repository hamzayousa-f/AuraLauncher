              ...
              return Positioned.fill(
                child: CustomPaint(
                  painter: FluidWavePainter(
                    ...
                    liquidColor: hardLocked ? Colors.redAccent.withOpacity(0.15) : Colors.cyanAccent.withOpacity(0.12),
                  ),
                ),
              );
            },
                  ...
                  Column(
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(color: hardLocked ? Colors.redAccent : Colors.white30, fontSize: 11, letterSpacing: 1.5, fontWeight: FontWeight.w600),
                      ),
                    ],
                  ),
...
class FluidWavePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Invert calculations because layout canvas Y vectors originate at maximum roof border structures
    ...
    for (double x = 0; x <= size.width; x++) {
      ...
      double y = targetHeight + (waveSine * 12); // Amplitude depth
      path.lineTo(x, y);
    }
